...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_NAME = "fmcgstock";
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTable = "CREATE TABLE " + TABLE_NAME + " (id INTEGER PRIMARY KEY AUTOINCREMENT, " +
                "CUSTNAM TEXT, ADDR TEXT, DATE TEXT, MKTNAM TEXT, PRODTNAM TEXT, MEASUR TEXT, NUMCAT TEXT, QTYCAT TEXT, TOTCAT TEXT, NUMROL TEXT, QTYROL TEXT, TOTROL TEXT, " +
                "EXTPCS TEXT, TOTPCS TEXT)";
    ...
    public boolean addData(String custmName, String address, String dat, String mrktName, String prodName, String measureT, String numbCat, String qttyCat, String totCat, String numbRol, String qttyRol, String totlRol,
                           String extrPcs, String totlPcs) {
